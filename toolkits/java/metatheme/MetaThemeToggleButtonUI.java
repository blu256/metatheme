...
public class MetaThemeToggleButtonUI extends MetalToggleButtonUI implements MT {

	private final static MetaThemeToggleButtonUI buttonUI = new MetaThemeToggleButtonUI();

	private ThemeEngine engine;
	private MouseListener mouseListener;

	public MetaThemeToggleButtonUI() {
		super();
	...
	protected void paintText(Graphics g, JComponent c, Rectangle textRect, String text) {
		...
		engine.drawString(g, MT_BUTTON_TOGGLE, state, textRect.x, textRect.y, text, engine.palette[Utils.getTextColor(state, MT_BUTTON_FOREGROUND)], mnemIndex);
	}
