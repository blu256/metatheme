...
public class MetaThemeRadioButtonUI extends MetalRadioButtonUI implements MT {

	private final static MetaThemeRadioButtonUI buttonUI = new MetaThemeRadioButtonUI();

	private ThemeEngine engine;
	private MouseListener mouseListener;

	public MetaThemeRadioButtonUI() {
		super();
